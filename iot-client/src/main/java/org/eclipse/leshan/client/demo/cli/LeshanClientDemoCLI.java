...
public class LeshanClientDemoCLI implements Runnable {
    ...
    /* ********************************** Battery ******************************** */
    @ArgGroup(validate = false,
              heading = "%n@|bold,underline Object Battery Options|@ %n%n"//
                      + "@|italic " //
                      + "Configure the battery function." //
                      + "|@%n%n")

    public BatterySection battery = new BatterySection();

    public static class BatterySection {
        @Option(names = { "-battery", "--enable-battery" },
                description = { //
                        "Enable a battery object.", //
                        "Just a flag" })
        public boolean enabled;
    ...
    /* ********************************** Solar Panel ******************************** */
    @ArgGroup(validate = false,
              heading = "%n@|bold,underline Object Solar Panel Options|@ %n%n"//
                      + "@|italic " //
                      + "Configure the solar panel function." //
                      + "|@%n%n")

    public SolarPanelSection solarpanel = new SolarPanelSection();

    public static class SolarPanelSection {
        @Option(names = { "-solar", "--enable-solar" },
                description = { //
                        "Enable a solar panel object.", //
                        "Just a flag" })
        public boolean enabled;
    ...
    /* ********************************** Budget Allocation ******************************** */
    @ArgGroup(validate = false,
              heading = "%n@|bold,underline Object Budget Allocation Options|@ %n%n"//
                      + "@|italic " //
                      + "Configure the budget allocation function." //
                      + "|@%n%n")

    public BudgetSection budgetallocation = new BudgetSection();

    public static class BudgetSection {
        @Option(names = { "-budget", "--enable-budget" },
                description = { //
                        "Enable a budget allocation object.", //
                        "Just a flag" })
        public boolean enabled;
