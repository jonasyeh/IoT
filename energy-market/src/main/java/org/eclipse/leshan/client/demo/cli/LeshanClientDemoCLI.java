...
public class LeshanClientDemoCLI implements Runnable {
    ...
    @ArgGroup(validate = false,
              heading = "%n@|bold,underline Energy Control Server Options|@ %n%n"//
                      + "@|italic " //
                      + "Specify the Energy Control Server." //
                      + "|@%n%n")
    public EnergySection energycontrol = new EnergySection();

    public static class EnergySection {
        @Option(names = { "-energy-url", "--energy-control" },
		defaultValue = "coap://localhost:5683",
                description = { //
                        "Specify the URL of the energy control server", //
                        "A URL" })
        public String url;
    }
    ...
    /* ********************************** Flow Control ******************************** */
    @ArgGroup(validate = false,
              heading = "%n@|bold,underline Flow Control Server Options|@ %n%n"//
                      + "@|italic " //
                      + "Specify the Flow Control Server." //
                      + "|@%n%n")
    public FlowSection flowcontrol = new FlowSection();

    public static class FlowSection {
        @Option(names = { "-flow-url", "--flow-control" },
		defaultValue = "coap://localhost:5683",
                description = { //
                        "Specify the URL of the flow control server", //
                        "A URL" })
        public String url;
    }
